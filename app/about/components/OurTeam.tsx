        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {team.members.map((member) => (
            ...
            >
              ...
              {/* Role Badge */}
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#00266A]/6 text-[#00266A] text-xs font-semibold tracking-wide mb-6">
                {member.role}
              </div>
              ...
              <div className="flex items-center justify-center gap-3 pt-2 border-t border-[#E7EAEE] w-full">
                ...
                {member.socials.facebook && (
                  <a
                    ...
                    className="w-9 h-9 rounded-full bg-[#1877F2]/10 hover:bg-[#1877F2] text-[#1877F2] hover:text-white flex items-center justify-center transition-all duration-200 shadow-2xs hover:scale-110"
                ...
                {member.socials.twitter && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 h-9 rounded-full bg-[#1DA1F2]/10 hover:bg-[#1DA1F2] text-[#1DA1F2] hover:text-white flex items-center justify-center transition-all duration-200 shadow-2xs hover:scale-110"
                ...
                {member.socials.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 h-9 rounded-full bg-[#E4405F]/10 hover:bg-[#E4405F] text-[#E4405F] hover:text-white flex items-center justify-center transition-all duration-200 shadow-2xs hover:scale-110"
