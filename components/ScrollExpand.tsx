...
const ScrollExpand: React.FC<ScrollExpandProps> = ({
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      const startOffsetRatio = c.useWindowScroll ? 0.5 : 0;
      track.style.height = `${stageH * (startOffsetRatio + Math.max(0, c.scrollDistance) + Math.max(0, c.holdDistance))}px`;
