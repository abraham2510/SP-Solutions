...
export interface VideoLinksEditorProps {
  videos: string[];
...
export function VideoLinksEditor({
  ...
  emptyMessage = "No demonstration videos added yet.",
  emptySubMessage = "Add YouTube trials, Instagram Reels, or MP4 video clips.",
      ...
      <div className="flex flex-col gap-3">
        ...
        <div>
          ...
          <p className="text-[10.5px] text-slate-400 text-center mt-1">
            Uploaded automatically to Cloudinary ({folder}) when you click Save.
          </p>
        </div>
