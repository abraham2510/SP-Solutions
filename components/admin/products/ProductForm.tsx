...
export function ProductForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      specifications: specifications.filter((s) => s.specification && s.value),
    };
    ...
    <form onSubmit={handleSubmit} className="w-full space-y-6 pb-24">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              {mode === "create"
                ? "Create a new machine entry for the SP Solutions catalogue."
                : `Updating ${initialData?.name || "product"} configuration.`}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardHeader className="flex flex-row items-center gap-3 border-b border-slate-100 p-5 bg-slate-50/50">
              ...
              <div>
                ...
                <CardDescription className="text-xs text-slate-500">
                  Product title, URL handle, category, and model designation
                </CardDescription>
              </div>
            </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g. Semi Auto Shrink Wrapping Machine"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="semi-auto-shrink-wrapping-machine"
          ...
          {/* Card 2: Product Images & Media Gallery */}
          <Card className="border-slate-200 bg-white shadow-2xs rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-6 space-y-5">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Brief summary displayed on product catalog cards..."
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Comprehensive description of machine construction, operation, and industrial benefits..."
                  className="text-xs text-slate-900 rounded-xl border-slate-200 focus:border-[#00266A]"
                />
              </div>
            </CardContent>
          ...
          {/* Card 4: Features, Applications & Specifications */}
          <Card className="border-slate-200 bg-white shadow-2xs rounded-2xl overflow-hidden">
            <CardHeader className="flex flex-row items-center gap-3 border-b border-slate-100 p-5 bg-slate-50/50">
          ...
          <Card className="border-slate-200 bg-white shadow-2xs rounded-2xl overflow-hidden">
            <CardHeader className="flex flex-row items-center gap-3 border-b border-slate-100 p-5 bg-slate-50/50">
              ...
              <div>
                ...
                <CardDescription className="text-xs text-slate-500">
                  Catalog visibility and homepage placement
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-6 space-y-5">
          ...
          <Card className="border-slate-200 bg-white shadow-2xs rounded-2xl overflow-hidden">
            <CardHeader className="flex flex-row items-center gap-3 border-b border-slate-100 p-5 bg-slate-50/50">
              ...
              <div>
                ...
                <CardDescription className="text-xs text-slate-500">
                  Thumbnail displayed on catalog lists
                </CardDescription>
              </div>
            </CardHeader>
